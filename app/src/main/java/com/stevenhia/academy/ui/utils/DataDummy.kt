package com.stevenhia.academy.ui.utils

import com.stevenhia.academy.ui.data.ModelCourseEntity
import com.stevenhia.academy.ui.data.ModelModuleEntity

object DataDummy {
    fun generateDummyCourses(): List<ModelCourseEntity> {

        val courses = ArrayList<ModelCourseEntity>()

        courses.add(ModelCourseEntity("a14",
        ...
        courses.add(ModelCourseEntity("a55",
        ...
        courses.add(ModelCourseEntity("a47",
        ...
        courses.add(ModelCourseEntity("a74",
        ...
        courses.add(ModelCourseEntity("a51",
    ...
    fun generateDummyModules(courseId: String): List<ModelModuleEntity> {

        val modules = ArrayList<ModelModuleEntity>()

        modules.add(ModelModuleEntity(
            "{$courseId}m1",
            courseId,
            "Modul 0 : Introduction",
            0, false))
        modules.add(ModelModuleEntity("{$courseId}m2",
            courseId,
            "Modul 1 : Teori 1",
            1, false))
        modules.add(ModelModuleEntity("{$courseId}m3",
            courseId,
            "Latihan 1",
            2, false))
        modules.add(ModelModuleEntity("{$courseId}m4",
            courseId,
            "Bedah Kode 1",
            3, false))
        modules.add(ModelModuleEntity("{$courseId}m5",
            courseId,
            "Modul 2 : Teori 2",
            4, false))

        modules.add(ModelModuleEntity("{$courseId}m6",
            courseId,
            "Latihan 2",
            5, false))

        modules.add(ModelModuleEntity("{$courseId}m7",
            courseId,
            "Bedah Kode 2",
            6, false))
