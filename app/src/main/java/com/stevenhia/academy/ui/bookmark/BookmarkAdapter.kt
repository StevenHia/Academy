...
import com.stevenhia.academy.databinding.ItemsBookmarkBinding
import com.stevenhia.academy.ui.data.ModelCourseEntity
import com.stevenhia.academy.ui.detail.DetailCourseActivity
...
class BookmarkAdapter(private val callback: BookmarkFragmentCallback) : RecyclerView.Adapter<BookmarkAdapter.CourseViewHolder>() {
    private val listCourses = ArrayList<ModelCourseEntity>()

    fun setCourses(courses: List<ModelCourseEntity>?) {
    ...
    inner class CourseViewHolder(private val binding: ItemsBookmarkBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(course: ModelCourseEntity) {
            with(binding) {
